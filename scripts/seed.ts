...
// given tag(s). The `/all` suffix (baked into the tag) requires the photo to
// match *every* tag — so "computer,mouse/all" is an actual computer mouse, not
// a rodent. `lock` pins a specific photo so the image is stable per seed.
...
const PRODUCTS: { title: string; category: string; price: number; stock: number; description: string; tag: string }[] = [
  ...
  { title: "Mechanical Keyboard (Hot-swappable)", category: "Electronics", price: 12900, stock: 60, description: "Tactile typing with per-key RGB and a CNC aluminium frame.", tag: "mechanical,keyboard/all" },
  ...
  { title: "Portable Bluetooth Speaker", category: "Electronics", price: 5900, stock: 75, description: "Room-filling 360° sound that's waterproof and pocket-ready.", tag: "bluetooth,speaker/all" },
  { title: "Ergonomic Wireless Mouse", category: "Electronics", price: 4900, stock: 90, description: "Silent clicks, precision tracking, and a 6-month battery.", tag: "computer,mouse/all" },
  { title: "7-in-1 USB-C Hub", category: "Electronics", price: 5400, stock: 65, description: "Expand one port into HDMI, USB-A, SD, and 100W passthrough.", tag: "usb,hub/all" },
  { title: "Portable SSD 1TB", category: "Electronics", price: 13900, stock: 50, description: "Pocketable, shock-resistant storage with 1050MB/s transfers.", tag: "ssd,drive/all" },
  { title: "Noise-Isolating Earbuds", category: "Electronics", price: 9900, stock: 80, description: "Crisp wireless audio with a compact charging case.", tag: "wireless,earbuds/all" },
  { title: "27\" QHD Gaming Monitor", category: "Electronics", price: 29900, stock: 22, description: "165Hz refresh, 1ms response, and vivid color accuracy.", tag: "computer,monitor/all" },
  ...
  { title: "E-Reader Paperwhite", category: "Electronics", price: 13900, stock: 40, description: "Glare-free 300ppi display that holds thousands of books.", tag: "ebook,reader/all" },
  ...
  { title: "Classic Denim Jacket", category: "Apparel", price: 7900, stock: 45, description: "A rugged, timeless layer that only gets better with age.", tag: "denim,jacket/all" },
  { title: "Full-Grain Leather Belt", category: "Apparel", price: 3900, stock: 70, description: "Hand-finished leather with a solid brushed-metal buckle.", tag: "leather,belt/all" },
  { title: "Ribbed Wool Beanie", category: "Apparel", price: 2400, stock: 110, description: "Cozy, stretchy, and warm for cold-weather days.", tag: "beanie,hat/all" },
  ...
  // Home & Kitchen
  { title: "Stainless Steel Cookware Set", category: "Home & Kitchen", price: 17900, stock: 20, description: "10-piece tri-ply set, oven-safe and dishwasher friendly.", tag: "cookware,pots/all" },
  { title: "Pour-Over Coffee Maker", category: "Home & Kitchen", price: 4500, stock: 80, description: "Barista-quality pour-over in a beautiful borosilicate carafe.", tag: "coffee,maker/all" },
  { title: "Ceramic Knife Block Set", category: "Home & Kitchen", price: 6900, stock: 30, description: "Ultra-sharp ceramic blades that stay sharp 10× longer than steel.", tag: "kitchen,knife/all" },
  ...
  { title: "Gooseneck Electric Kettle", category: "Home & Kitchen", price: 5900, stock: 60, description: "Precise pour and variable temperature control in 60 seconds.", tag: "electric,kettle/all" },
  ...
  { title: "16-Piece Dinnerware Set", category: "Home & Kitchen", price: 8900, stock: 35, description: "Chip-resistant stoneware service for four.", tag: "dinnerware,plates/all" },
  ...
  { title: "Turkish Cotton Bath Towel Set", category: "Home & Kitchen", price: 5400, stock: 70, description: "Plush, quick-drying, and softer with every wash.", tag: "bath,towels/all" },
  { title: "HEPA Air Purifier", category: "Home & Kitchen", price: 12900, stock: 28, description: "Captures 99.97% of dust, pollen, and allergens.", tag: "air,purifier/all" },
